...
class AutoReport(object):
    ...
    def submitData(self, date, timeMark):
        try:
            ...
            stayButton = self.__browser.find_element_by_id("fineui_11-inputEl-icon")
            stayButton.click()
            # live with people from high-risk area(no)
            liveButton = self.__browser.find_element_by_id("fineui_13-inputEl-icon")
            liveButton.click()
            # address
            ...
            submitButton.click()
            self.__browser.implicitly_wait(1)
            submitConfirmButton = self.__browser.find_element_by_id("fineui_32")
